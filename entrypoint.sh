...
COMMAND="kubescape scan $FRAMEWORKS_CMD $CONTROLS_CMD $FILES $ACCOUNT_OPT $FAIL_THRESHOLD_OPT $SEVERITY_THRESHOLD_OPT --format json --format-version v2 --output output.json  --use-artifacts-from $ARTIFACTS_PATH && yes | kubescape fix output.json"
